module.exports = {
  ...
  extends: ['eslint:recommended', 'plugin:vue/recommended', 'plugin:@typescript-eslint/eslint-recommended', 'plugin:@typescript-eslint/recommended'],
  ...
  rules: {
    ...
    'vue/multiline-html-element-content-newline': ['warn', { ignores: ['pre', 'textarea', 'code'] }],
